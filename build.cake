...
var sln = new FilePath("./Xamarin-Sidebar.sln");
...
Setup(context => {
    ...
    Information(Figlet("Xamarin-Sidebar"));
...
Task("PublishPackages")
    ...
    .WithCriteria(() => IsRepository("jdehlin/Xamarin-Sidebar"))
    ...
    .Does (() =>
{
    ...
    var nugetFiles = GetFiles("Xamarin-Sidebar*/**/bin/" + configuration + "/**/*.nupkg");
    ...
    .Does(() => 
{
    ...
    var artifacts = GetFiles("Xamarin-Sidebar*/**/bin/" + configuration + "/**/*.nupkg")
